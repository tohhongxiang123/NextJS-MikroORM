...
export default function DeckPage({ decks }: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleCreateDeck}>
                ...
                <button type="submit" disabled={mutation.isLoading}>Create deck</button>
