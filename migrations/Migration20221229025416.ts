...
export class Migration20221229025416 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "user" ("id" varchar(255) not null, "name" varchar(255) not null, "email" varchar(255) not null, "email_verified" timestamptz(0) null, "image" varchar(255) null, constraint "user_pkey" primary key ("id"));');
    ...
    this.addSql('create table "verification_token" ("token" varchar(255) not null, "expires" timestamptz(0) not null, "identifier" varchar(255) not null, constraint "verification_token_pkey" primary key ("token"));');
